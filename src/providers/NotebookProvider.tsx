...
export const NotebookProvider = ({
  ...
  const { report, reportRef, save: saveReport } = useReportContext();
  ...
  }, [ !changed ? report?.notebook?.content : null, !changed ? notebook : null ]);
...
/*  useNotebookEvent('CELL_RESULT', (data: any) => {
  ...
  const contextValue = useMemo(() => ({
    notebook, notebookRef, setNotebook, setCell, changed, save,
    isSaving: false,
  }), [ notebook, changed ]);
